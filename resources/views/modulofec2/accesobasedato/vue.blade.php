...
Vue.component('ckeditor2', {
 ...
 let app = new Vue({
    ...
    data:{
        ...
        subtitulo: "Gestión de Publicaciones de base de Datos",
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var v3 = 0;
            var url = '/intranet/basedatosre?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/basedatosre/'+dato.id;
        ...
        borrarImage:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/basedatosre/deleteimg/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        borrarFile:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/basedatosre/deletefile/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        update: function (id) {
            ...
            var url="/intranet/basedatosre/"+id;
        ...
        baja:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/basedatosre/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/basedatosre/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
