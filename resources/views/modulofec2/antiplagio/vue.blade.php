...
Vue.component('ckeditor2', {
 ...
 let app = new Vue({
    ...
    data:{
        ...
        subtitulo: "Gestión de Publicaciones Antiplagio",
        ...
        fillobject:{ 'id':'', 'titulo':'', 'descripcion':'','nombrefile':'','url':'', 'urllink':'','activo':'','oldImg':'', 'oldFile':'', 'tieneimagen':'','tienelink':''},
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var v3 = 0;
            var url = '/intranet/antiplagiore?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/antiplagiore/'+dato.id;
        ...
        borrarImage:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/antiplagiore/deleteimg/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        borrarFile:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/antiplagiore/deletefile/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        cerrarFormE: function(){
            ...
            this.$nextTick(function () {
                this.fillobject={ 'id':'', 'titulo':'', 'descripcion':'','nombrefile':'','url':'', 'urllink':'','activo':'','oldImg':'', 'oldFile':'', 'tieneimagen':'','tienelink':''};
        ...
        update: function (id) {
            ...
            var url="/intranet/antiplagiore/"+id;
        ...
        baja:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/antiplagiore/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/antiplagiore/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
