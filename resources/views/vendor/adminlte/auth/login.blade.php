...
@section('content')
    <body class="hold-transition login-page" style=" background-image: url('{{ asset('/img/samu 02.jpg') }}');    background-size: cover;
...
{{--                 <div class="card2" style="text-align: center;margin-top: 50px;border-radius: 3px">
            ...
            <div class="login-logo" style="    background-color: white !important;     border-radius: 10px;">
                
                <a href="{{ url('/home') }}" style="font-size:28px; display:inline-block;">
                    <b>PLATAFORMA VIRTUAL</b> <br>
                    <img src="{{ asset('/img/logo.jpg') }}" alt="" style="padding-top: 10px;width: 300px; display:inline-block;"> <b>  <br>Inicio de Sesión</b></a>
            </div><!-- /.login-logo -->
            ...
            <div class="login-box-body" style=" background-color: white !important;    border-radius: 10px;">
