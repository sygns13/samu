 ...
 let app = new Vue({
    ...
    data:{
      titulo:"Portal Web Programas de Estudios de la FEC",
        ...
        fillobject:{ 'id':'', 'titulo':'', 'descripcion':'' , 'tieneimagen':'0', 'url':'','oldImg':''},
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            this.fillobject = { 'id':'', 'titulo':'', 'descripcion':'' , 'tieneimagen':'0', 'url':'','oldImg':''};
        ...
        if(this.fillobject.tieneimagen!= null && this.fillobject.tieneimagen == 1){
            $("#imgInformacion").attr("src","{{ asset('/web/presentacionprograma')}}"+"/"+image);
        }
