  ...
  <div class="box-body" style="font-size: 14px;">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      <div class="form-group">
        <label for="txttitularE" class="col-sm-2 control-label">Título de la Noticia:*</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" id="txttitularE" name="txttitularE" placeholder="Titular de la Noticia"
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      <div class="form-group">
        <label for="txtfechaE" class="col-sm-2 control-label">Fecha de Noticia:<spam style="color:red;">*</spam></label>
        <div class="col-sm-2">
        ...
        <label for="txthoraE" class="col-sm-2 control-label">Hora de Noticia:<spam style="color:red;">*</spam></label>
        <div class="col-sm-2">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      ...
      <div class="form-group">
          <label for="txtdesarrollo" class="col-sm-2 control-label">Desarrollo de la Noticia:*</label>
          <div class="col-sm-10">
