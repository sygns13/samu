...
Vue.component('ckeditor4', {
 ...
 let app = new Vue({
    ...
    data:{
        ...
        // Gestionar imagenes de noticias
    ...
    methods: {
      getDatos: function (page) {
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/noticiasre/'+dato.id;
        ...
        this.uploadReadyE=false;
            ...
            this.fillobject.titular=dato.titular;
            ...
            if(this.fillobject.tieneimagen == 1){
              dato.imagennoticia.forEach( function(valor, indice, array) {
                if(valor.posicion == 0){
        ...
        update: function (id) {
            ...
            var url="/intranet/noticiasre/"+id;
            ...
            data.append('titular', this.fillobject.titular);
        ...
        baja:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si se desactiva la Noticia, No se mostrará en el Portal Web, hasta que sea activada nuevamente",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/noticiasre/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si activa la Noticia, se mostrará en el Portal Web",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/noticiasre/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
      ...
      //Seccion Imagenes de detalle Noticia
      ...
      gestionarImages:function (dato){
        ...
        this.detalleImagenes = dato.imagennoticia;
...
/*
        ...
        $("#boxTituloModalDetalles").text("Noticia: "+dato.titular);
      ...
      nuevaImg:function () {
        ...
        createImg:function () {
            var url='/intranet/imagennoticiasre';
        ...
        getDatosImagenes: function () {
            ...
            var url = '/intranet/imagennoticiasre?noticia_id='+this.fillobject.id;
            axios.get(url).then(response=>{

                this.detalleImagenes= response.data.imagennoticia;

                this.noticias.forEach( function(valor, indice, array) {
                  if(valor.id == app.fillobject.id){
                    app.noticias[indice].imagennoticia = app.detalleImagenes;
                  }
               });
        ...
        borrarImg:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/imagennoticiasre/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        editImg:function (dato) {
          ...
          updateImg: function (id) {
            ...
            var url="/intranet/imagennoticiasre/"+id;
