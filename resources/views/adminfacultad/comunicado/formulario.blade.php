  ...
  <div class="box-body" style="font-size: 14px;">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txttitular" class="col-sm-2 control-label">Título del Comunicado:*</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="txttitular" name="txttitular" placeholder="Titulo del Comunicado"
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txtfecha" class="col-sm-2 control-label">Fecha del Comunicado:<spam style="color:red;">*</spam></label>
          <div class="col-sm-2">
          ...
          <label for="txthora" class="col-sm-2 control-label">Hora del Comunicado:<spam style="color:red;">*</spam></label>
          <div class="col-sm-2">
