...
Vue.component('ckeditor4', {
 ...
 let app = new Vue({
    ...
    data:{
        ...
        // Gestionar imagenes de comunicados
    ...
    methods: {
      getDatos: function (page) {
            ...
            axios.get(url).then(response=>{
                ...
                this.comunicados= response.data.comunicados.data;
                this.pagination= response.data.pagination;

                //this.mostrarPalenIni=true;

                if(this.comunicados.length==0 && this.thispage!='1'){
        ...
        create:function () {
            var url='/intranet/comunicadosre';
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/comunicadosre/'+dato.id;
        ...
        this.uploadReadyE=false;
            ...
            if(this.fillobject.tieneimagen == 1){
              dato.imagencomunicado.forEach( function(valor, indice, array) {
                if(valor.posicion == 0){
        ...
        update: function (id) {
            ...
            var url="/intranet/comunicadosre/"+id;
        ...
        baja:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/comunicadosre/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/comunicadosre/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
      ...
      //Seccion Imagenes de detalle Comunicado
      ...
      gestionarImages:function (dato){
        ...
        this.detalleImagenes = dato.imagencomunicado;
        ...
        $("#boxTituloModalDetalles").text("Comunicado: "+dato.titulo);
      ...
      createImg:function () {
          var url='/intranet/imagencomunicadosre';
      ...
      getDatosImagenes: function () {
          ...
          var url = '/intranet/imagencomunicadosre?comunicado_id='+this.fillobject.id;
          axios.get(url).then(response=>{

              this.detalleImagenes= response.data.imagencomunicado;

              this.comunicados.forEach( function(valor, indice, array) {
                if(valor.id == app.fillobject.id){
                  app.comunicados[indice].imagencomunicado = app.detalleImagenes;
                }
            });
      ...
      borrarImg:function (dato) {
        swal.fire({
          ...
          if (result.value) {
              var url = '/intranet/imagencomunicadosre/'+dato.id;
              axios.delete(url).then(response=>{//eliminamos
      ...
      editImg:function (dato) {
        ...
        updateImg: function (id) {
          ...
          var url="/intranet/imagencomunicadosre/"+id;
