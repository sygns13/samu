      ...
      <div class="modal-dialog modal-lg" role="document" id="modaltamanio">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="boxTituloModal" style="font-weight: bold;text-decoration: underline;">GESTION DE IMÁGENES DE LA HISTORIA DE LA FACULTAD DE ECONOMÍA Y CONTABILIDAD</h4>
                ...
                <div class="box-body" v-if="!divNuevaImagen && !divEditImagen">
                    <div class="col-md-12">
                      ...
                      <div class="box box-success" v-if="divNuevaImagen">
                        ...
                        @include('modulofec1.historia.detalleformularioimg')  
                      </div>
                      ...
                      <div class="box box-warning" v-if="divEditImagen">
                        ...
                        @include('modulofec1.historia.detalleeditarimg')  
                        ...
                        <table class="table table-hover table-bordered" >
                          ...
                          <tr v-for="imagen, key in detalleImagenes" v-if="imagen.posicion > 0">
                            ...
                            <td style="border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">
                                <center>
                                  <img v-bind:src="'{{ asset('/web/historiafec/')}}'+'/'+imagen.url" style="max-height: 200px;border: solid 1px black;" class="img-responsive" alt="Imagen del Contenido Informativo" id="imgInformacion">
                                </center>
                            </td>
