...
Vue.component('ckeditor2', {
 ...
 let app = new Vue({
    ...
    data:{
        titulo:"Páginas FEC",
        subtitulo: "Gestión de Políticas de Calidad",
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var v3 = 0;
            var url = '/intranet/politicasre?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/politicasre/'+dato.id;
        ...
        borrarImage:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/politicasre/deleteimg/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        borrarFile:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/politicasre/deletefile/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        update: function (id) {
            ...
            var url="/intranet/politicasre/"+id;
        ...
        baja:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si se desactiva el Contenido, No se mostrará en el Portal Web de la Facultad, hasta que sea activado nuevamente",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/politicasre/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/politicasre/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
