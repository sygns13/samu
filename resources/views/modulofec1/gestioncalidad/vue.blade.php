...
Vue.component('ckeditor2', {
 ...
 let app = new Vue({
    ...
    data:{
        titulo:"Páginas FEC",
        subtitulo: "Gestión de Publicaciones de Gestión de Calidad",
        ...
        fillobject:{ 'id':'', 'descripcion':'','titulo':'', 'url':'','activo':'','oldImg':''},
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var v3 = 0;
            var url = '/intranet/gestioncalidadre?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;

            axios.get(url).then(response=>{

                this.gestioncalidads= response.data.gestioncalidads.data;
                this.pagination= response.data.pagination;

                //this.mostrarPalenIni=true;

                if(this.gestioncalidads.length==0 && this.thispage!='1'){
        ...
        create:function () {
            var url='/intranet/gestioncalidadre';
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/gestioncalidadre/'+dato.id;
        ...
        cerrarFormE: function(){
            ...
            this.$nextTick(function () {
                this.fillobject={ 'id':'', 'descripcion':'','titulo':'', 'url':'','activo':'','oldImg':''};
        ...
        update: function (id) {
            ...
            var url="/intranet/gestioncalidadre/"+id;
        ...
        baja:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/gestioncalidadre/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si activa la Publicación, se mostrará en el Portal Web de la Facultad en el número de su posición",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/gestioncalidadre/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
