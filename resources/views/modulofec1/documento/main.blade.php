<div class="panel panel-primary" v-if="mostrarPalenIni">
  <div class="panel-heading" style="padding-bottom: 15px;">
    <h3 class="panel-title">Gestión de Documentos Normativos de la Facultad de Economía y Contabilidad<a style="float: right; padding: all; color: black;" type="button" class="btn btn-default btn-sm" href="{{URL::to('home')}}"><i class="fa fa-reply-all" aria-hidden="true"></i> 
    Volver</a></h3>
...
<div class="box box-success" v-if="divNuevo">
  ...
  @include('modulofec1.documento.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit">
  ...
  @include('modulofec1.documento.editar')  

</div>

<div class="panel panel-primary" >
  <div class="panel-heading" style="padding-bottom: 20px;">
    <h3 class="panel-title">Listado de Documentos Normativos de la Facultad de Economía y Contabilidad
    ...
    <table class="table table-hover table-bordered" >
      ...
      <tr v-for="documento, key in documentos">
        ...
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">
          <center>
              <a v-bind:href="'{{ asset('/web/documentofec/')}}'+'/'+documento.url"  class="btn btn-primary btn-xs" download> Descargar</a>
            </center>
        </td>
