...
Vue.component('ckeditor2', {
 ...
 let app = new Vue({
    ...
    data:{
        titulo:"Páginas FEC",
        subtitulo: "Gestión de Documentos Normativos",
    ...
    methods: {
        ...
        baja:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si se desactiva el Documento, No se mostrará en el Portal Web de la Facultad, hasta que sea activado nuevamente",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si activa el Documento, se mostrará en el Portal Web de la Facultad en el número de su posición",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
