<form v-on:submit.prevent="create">
  <div class="box-body" style="font-size: 14px;">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      ...
      <div class="form-group">
          <label for="txtnumero" class="col-sm-2 control-label">Número del Objetivo:*</label>
          <div class="col-sm-4">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txttitulo" class="col-sm-2 control-label">Nombre del Objetivo:*</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="txttitulo" name="txttitulo" placeholder="Nombre del Objetivo"
  ...
  <div class="col-md-12" style="padding-top: 15px;">
    ...
    <div class="form-group">
      <label for="cbuestado" class="col-sm-2 control-label">Imagen del Objetivo (Recomendado 500 x 500 px)</label>
