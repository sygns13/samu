...
Vue.component('ckeditor2', {
 ...
 let app = new Vue({
    ...
    data:{
        ...
        fillobject:{ 'id':'', 'nombre':'', 'cargo':'', 'posision':'', 'descripcion':'','url':'', 'telefono':'', 'email':'','activo':'','oldImg':'', 'tieneimagen':''},
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var v3 = 0;
            var url = '/intranet/directoriore?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;

            axios.get(url).then(response=>{

                this.directorios= response.data.directorios.data;
                this.pagination= response.data.pagination;

                //this.mostrarPalenIni=true;

                if(this.directorios.length==0 && this.thispage!='1'){
        ...
        borrar:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "¿Desea eliminar el registro seleccionada? -- Nota: Este proceso no se podrá revertir",
              type: 'info',
            ...
            if (result.value) {
                var url = '/intranet/directoriore/'+dato.id;
        ...
        borrarImage:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/directoriore/deleteimg/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        cerrarFormE: function(){
            ...
            this.$nextTick(function () {
                this.fillobject={ 'id':'', 'nombre':'', 'cargo':'', 'posision':'', 'descripcion':'','url':'', 'telefono':'', 'email':'','activo':'','oldImg':'', 'tieneimagen':''};
        ...
        update: function (id) {
            ...
            var url="/intranet/directoriore/"+id;
            ...
            data.append('cargo', this.fillobject.cargo);
        ...
        baja:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si se desactiva el Registro seleccionado, No se mostrará en el Portal Web de la Facultad, hasta que sea activado nuevamente",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/directoriore/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si activa el Registro seleccionado, se mostrará en el Portal Web de la Facultad en el número de su posición",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/directoriore/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
