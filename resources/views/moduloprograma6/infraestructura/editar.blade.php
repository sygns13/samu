  ...
  <div class="box-body" style="font-size: 14px;">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      <div class="form-group">
        <label for="txttituloE" class="col-sm-2 control-label">Titulo de la Infraestructura:*</label>
        <div class="col-sm-10">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      ...
      <div class="form-group">
          <label for="descripcionE" class="col-sm-2 control-label">Descripción de la Infraestructura:</label>
          <div class="col-sm-10">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      ...
      <div class="form-group">
        <label for="txtArchivoAdjuntoE" class="col-sm-2 control-label">Archivo Adjunto: Malla Curricular (Opcional: pdf, docx, xlsx, pptx)</label>
