 ...
 let app = new Vue({
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var url = '/intranet/infraestructuraprogramare?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;
        ...
        create:function () {
            var url='/intranet/infraestructuraprogramare';
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/infraestructuraprogramare/'+dato.id;
        ...
        borrarImage:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/infraestructuraprogramare/deleteimg/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        borrarFile:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/infraestructuraprogramare/deletefile/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        update: function (id) {
            ...
            var url="/intranet/infraestructuraprogramare/"+id;
        ...
        baja:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/infraestructuraprogramare/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/infraestructuraprogramare/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
