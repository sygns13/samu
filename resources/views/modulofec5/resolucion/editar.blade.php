  ...
  <div class="box-body" style="font-size: 14px;">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      <div class="form-group">
        <label for="txtnombreE" class="col-sm-2 control-label">Nombre de Resolución:*</label>
        <div class="col-sm-10">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      ...
      <div class="form-group">
          ...
          <label for="txtfechaE" class="col-sm-2 control-label">Fecha de la Resolución:<spam style="color:red;">*</spam></label>
        <div class="col-sm-2">
