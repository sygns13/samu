  ...
  <div class="box-body" style="font-size: 14px;">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txtnombre" class="col-sm-2 control-label">Nombre de Resolución:*</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="txtnombre" name="txtnombre" placeholder="Nombre de Resolución"
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        ...
        <div class="form-group">
            ...
            <label for="txtfecha" class="col-sm-2 control-label">Fecha de la Resolución:<spam style="color:red;">*</spam></label>
          <div class="col-sm-2">
