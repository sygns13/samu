<form v-on:submit.prevent="create">
    <div class="box-body" style="font-size: 14px;">
      ...
      <div class="col-md-12" >
        <div class="form-group">
          <label for="txtnombre_tupa" class="col-sm-2 control-label">Título:*</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="txtnombre_tupa" name="txtnombre_tupa" placeholder="Título del TUPA"
              maxlength="500" @keydown="$event.keyCode === 13 ? $event.preventDefault() : false" v-model="nombre_tupa">
          </div>
        </div>
      </div>
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      <div class="form-group">
        <label for="cbuarchivo" class="col-sm-2 control-label">Archivo PDF del TUPA</label>
