...
<div class="panel panel-primary" v-if="mostrarPalenIni && programa_id!=0">
  <div class="panel-heading" style="padding-bottom: 15px;">
    <h3 class="panel-title">Gestión de Objetivos Educacionales del Programa de Estudio de @{{programa}} <a style="float: right; padding: all; color: black;" type="button" class="btn btn-default btn-sm" href="#"  @click.prevent="irAtras()"><i class="fa fa-reply-all" aria-hidden="true"></i> 
      Ir Atrás</a></h3>
...
<div class="box box-success" v-if="divNuevo && programa_id!=0">
  ...
  @include('moduloprograma1.objetivos.formulario')  
</div>
...
<div class="box box-warning" v-if="divEdit && programa_id!=0">
  ...
  @include('moduloprograma1.objetivos.editar')  

</div>

<div class="panel panel-primary" v-if="programa_id!=0">
  <div class="panel-heading" style="padding-bottom: 20px;">
    <h3 class="panel-title">Listado de Objetivos Educacionales del Programa de Estudio de @{{programa}}
    ...
    <table class="table table-hover table-bordered" >
      ...
      <tr v-for="objetivo, key in objetivos">
        ...
        <td style=";border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">{{-- @{{ objetivo.url }} --}}
          ...
          <center>
            <img v-bind:src="'{{ asset('/web/objetivoprograma/')}}'+'/'+objetivo.url" style="max-height: 200px;border: solid 1px black;" class="img-responsive" alt="Imagen del Contenido Informativo" id="imgInformacion">
            </center>
        </td>
