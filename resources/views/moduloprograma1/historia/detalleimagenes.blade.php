    <div class="modal fade bs-example-modal-lg" id="modalDetalles"  role="dialog" aria-labelledby="myLargeModalLabel" v-if="programa_id!=0">
      <div class="modal-dialog modal-lg" role="document" id="modaltamanio">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="boxTituloModal" style="font-weight: bold;text-decoration: underline;">Gestion de Imágenes de la Historia del Programa de Estudio de @{{programa}}</h4>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="box box-success" v-if="divNuevaImagen">
                        <div class="box-header with-border" style="border: 1px solid rgb(0, 166, 90); background-color: rgb(0, 166, 90); color: white;">
                            <h3 class="box-title" id="tituloAgregar">Nueva Imagen
                            </h3>
                          </div>
                       
                        @include('moduloprograma1.historia.detalleformularioimg')  
                      </div>
                      ...
                      <div class="box box-warning" v-if="divEditImagen">
                        ...
                        @include('moduloprograma1.historia.detalleeditarimg')  
                        ...
                        <table class="table table-hover table-bordered" >
                          ...
                          <tr v-for="imagen, key in detalleImagenes" v-if="imagen.posicion > 0">
                            ...
                            <td style="border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">
                                <center>
                                  <img v-bind:src="'{{ asset('/web/historiaprograma/')}}'+'/'+imagen.url" style="max-height: 200px;border: solid 1px black;" class="img-responsive" alt="Imagen del Contenido Informativo" id="imgInformacion">
                                </center>
                            </td>
