<form v-on:submit.prevent="create">
  <div class="box-body" style="font-size: 14px;">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txttitulo" class="col-sm-2 control-label">Nombres y Apellidos:<spam style="color:red;">*</spam></label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="txttitulo" name="txttitulo" placeholder="Nombres y Apellidos"
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        ...
        <div class="form-group">
            <label for="txtdescripcion" class="col-sm-2 control-label">Contenido:</label>
            <div class="col-sm-10">
  ...
  <div class="col-md-12" style="padding-top: 15px;">
    ...
    <div class="form-group">
      <label for="cbuestado" class="col-sm-2 control-label">Imagen del Docente ( Opcional Recomendado 500 x 500 px)</label>
