  ...
  <div class="box-body" style="font-size: 14px;">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      <div class="form-group">
        <label for="txttituloE" class="col-sm-2 control-label">Nombres y Apellidos:<spam style="color:red;">*</spam></label>
        <div class="col-sm-10">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      ...
      <div class="form-group">
        <label for="txtdescripcionE" class="col-sm-2 control-label">Contenido:</label>
          <div class="col-sm-10">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
                    ...
                    <div class="form-group">
                      <label for="archivoE" class="col-sm-2 control-label">Imagen del Docente : (Opcional)</label>
