...
Vue.component('ckeditor2', {
 ...
 let app = new Vue({
    ...
    data:{
        ...
        fillobject:{ 'id':'', 'titulo':'', 'descripcion':'','nombrefile':'','urlimagen':'', 'urllink':'','activo':'','oldImg':'', 'oldFile':'', 'tieneimagen':'','tienelink':''},
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var v3 = 0;
            var url = '/intranet/docentesfecre?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;
        ...
        create:function () {
            var url='/intranet/docentesfecre';
        ...
        borrar:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "¿Desea eliminar la Publicación del Docente seleccionada? -- Nota: Este proceso no se podrá revertir",
              type: 'info',
            ...
            if (result.value) {
                var url = '/intranet/docentesfecre/'+dato.id;
        ...
        borrarImage:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/docentesfecre/deleteimg/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        borrarFile:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/docentesfecre/deletefile/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        cerrarFormE: function(){
            ...
            this.$nextTick(function () {
                this.fillobject={ 'id':'', 'titulo':'', 'descripcion':'','nombrefile':'','urlimagen':'', 'urllink':'','activo':'','oldImg':'', 'oldFile':'', 'tieneimagen':'','tienelink':''};
        ...
        update: function (id) {
            ...
            var url="/intranet/docentesfecre/"+id;
        ...
        baja:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si se desactiva la Publicación del Docente, No se mostrará en el Portal Web de la Facultad, hasta que sea activado nuevamente",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/docentesfecre/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si activa la Publicación del Docente, se mostrará en el Portal Web de la Facultad",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/docentesfecre/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
