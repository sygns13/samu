  ...
  <div class="box-body" style="font-size: 14px;">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txttitulo" class="col-sm-2 control-label">Titulo del Plan de Estudio:*</label>
          <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        ...
        <div class="form-group">
          <label for="descripcion" class="col-sm-2 control-label">Descripción del Plan de Estudio:</label>
            <div class="col-sm-10">
...
<div class="col-md-12" style="padding-top: 15px;">
  ...
  <div class="form-group">
    <label for="txtnombrefile" class="col-sm-2 control-label">Archivo Adjunto: Malla Curricular (Opcional: pdf, docx, xlsx, pptx)</label>
