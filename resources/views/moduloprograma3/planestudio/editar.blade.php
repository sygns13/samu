  ...
  <div class="box-body" style="font-size: 14px;">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      <div class="form-group">
        <label for="txttituloE" class="col-sm-2 control-label">Titulo del Plan de Estudio:*</label>
        <div class="col-sm-10">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      ...
      <div class="form-group">
          <label for="descripcionE" class="col-sm-2 control-label">Descripción del Plan de Estudio:</label>
          <div class="col-sm-10">
