 ...
 let app = new Vue({
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var url = '/intranet/planestudiosprogramare?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;
        ...
        create:function () {
            var url='/intranet/planestudiosprogramare';
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/planestudiosprogramare/'+dato.id;
        ...
        borrarImage:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/planestudiosprogramare/deleteimg/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        borrarFile:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/planestudiosprogramare/deletefile/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        update: function (id) {
            ...
            var url="/intranet/planestudiosprogramare/"+id;
        ...
        baja:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/planestudiosprogramare/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/planestudiosprogramare/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
