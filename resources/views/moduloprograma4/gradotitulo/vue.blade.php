 ...
 let app = new Vue({
    ...
    data:{
      titulo:"Grados y Títulos",
        ...
        fillobject:{ 'id':'', 'titulo':'', 'descripcion':'','url':'', 'activo':'','oldImg':'', 'tieneimagen':''},
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var url = '/intranet/gradosprogramare?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;
        ...
        create:function () {
            var url='/intranet/gradosprogramare';
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/gradosprogramare/'+dato.id;
        ...
        borrarImage:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/gradosprogramare/deleteimg/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        cerrarFormE: function(){
            ...
            this.$nextTick(function () {
                this.fillobject= { 'id':'', 'titulo':'', 'descripcion':'','url':'', 'activo':'','oldImg':'', 'tieneimagen':''};
        ...
        update: function (id) {
            ...
            var url="/intranet/gradosprogramare/"+id;
        ...
        baja:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si se desactiva el Registro, No se mostrará en el Portal del Programa de Estudio, hasta que sea activado nuevamente",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/gradosprogramare/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si activa el Registro, se mostrará en el Portal del Programa de Estudio en el número de su posición",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/gradosprogramare/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
