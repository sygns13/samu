  ...
  <div class="box-body" style="font-size: 14px;">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txttitulo" class="col-sm-2 control-label">Nombre del Grado o Título:*</label>
          <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        ...
        <div class="form-group">
          <label for="descripcion" class="col-sm-2 control-label">Descripción del Grado o Título:</label>
            <div class="col-sm-10">
