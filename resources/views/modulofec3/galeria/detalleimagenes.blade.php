        ...
        <div class="modal-content">
          ...
          <div class="box" id="o" style="border:0px; box-shadow:none;" >
                <div class="box-header with-border">
                  <h3 class="box-title" id="boxTituloModalDetalles">Publicación:</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="box box-success" v-if="divNuevaImagen">
                        <div class="box-header with-border" style="border: 1px solid rgb(0, 166, 90); background-color: rgb(0, 166, 90); color: white;">
                            <h3 class="box-title" id="tituloAgregar">Nueva Imagen de la Publicación
                            </h3>
                          </div>
                       
                        @include('modulofec3.galeria.detalleformularioimg')  
                      </div>
                      ...
                      <div class="box box-warning" v-if="divEditImagen">
                        ...
                        @include('modulofec3.galeria.detalleeditarimg')  
                        ...
                        <table class="table table-hover table-bordered" >
                          ...
                          <tr v-for="imagen, key in detalleImagenes" v-if="imagen.posicion > 0">
                            ...
                            <td style="border:1px solid #ddd;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; padding: 5px;">
                                <center>
                                  <img v-bind:src="'{{ asset('/web/galeriafec/')}}'+'/'+imagen.url" style="max-height: 200px;border: solid 1px black;" class="img-responsive" alt="Imagen del Contenido Informativo" id="imgInformacion">
                                </center>
                            </td>
