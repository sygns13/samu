...
Vue.component('ckeditor4', {
 ...
 let app = new Vue({
    el: '#app',
    data:{
        titulo:"Páginas de la FEC",
        subtitulo: "Gestión de Galería",
        ...
        // Gestionar imagenes de galerias
    ...
    methods: {
      getDatos: function (page) {
            ...
            var v3 = 0;
            var url = '/intranet/galeriare?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/galeriare/'+dato.id;
        ...
        this.uploadReadyE=false;
            ...
            if(this.fillobject.tieneimagen == 1){
              dato.imagengaleria.forEach( function(valor, indice, array) {
                if(valor.posicion == 0){
        ...
        baja:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si se desactiva la Publicación, No se mostrará en el Portal Web, hasta que sea activada nuevamente",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/galeriare/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si activa la Publicación, se mostrará en el Portal Web",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/galeriare/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
      ...
      //Seccion Imagenes de detalle Galeria
      ...
      gestionarImages:function (dato){
        ...
        this.detalleImagenes = dato.imagengaleria;
...
/*
        ...
        $("#boxTituloModalDetalles").text("Galeria: "+dato.nombre);
      ...
      nuevaImg:function () {
        ...
        createImg:function () {
            var url='/intranet/imagengaleriare';
            ...
            data.append('galeria_id', this.fillobject.id);
            data.append('v1', v1);
            data.append('v2', v2);
            data.append('v3', v3);
        ...
        getDatosImagenes: function () {
            ...
            var url = '/intranet/imagengaleriare?galeria_id='+this.fillobject.id;
            axios.get(url).then(response=>{

                this.detalleImagenes= response.data.imagengaleria;

                this.galerias.forEach( function(valor, indice, array) {
                  if(valor.id == app.fillobject.id){
                    app.galerias[indice].imagengaleria = app.detalleImagenes;
                  }
               });
        ...
        borrarImg:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/imagengaleriare/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        editImg:function (dato) {
          ...
          updateImg: function (id) {
            ...
            var url="/intranet/imagengaleriare/"+id;
