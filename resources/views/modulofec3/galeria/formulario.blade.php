  ...
  <div class="box-body" style="font-size: 14px;">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txtnombre" class="col-sm-2 control-label">Nombre de la Publicación:<spam style="color:red;">*</spam></label>
          <div class="col-sm-10">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        <div class="form-group">
          <label for="txtfecha" class="col-sm-2 control-label">Fecha de la Publicación:<spam style="color:red;">*</spam></label>
          <div class="col-sm-2">
      ...
      <div class="col-md-12" style="padding-top: 15px;">
        ...
        <div class="form-group">
            <label for="txtdesarrollo" class="col-sm-2 control-label">Descripción: (Opcional)</label>
            <div class="col-sm-10">
