  ...
  <div class="box-body" style="font-size: 14px;">
    ...
    <div class="col-md-12" style="padding-top: 15px;">
      <div class="form-group">
        <label for="cbutipoE" class="col-sm-2 control-label">Tipo de Competencia:*</label>
        <div class="col-sm-4">
          <select class="form-control" id="cbutipoE" name="cbutipoE" v-model="fillobject.tipo">
            <option value="1">Competencia General</option>
            <option value="2">Competencia Específica</option>
          </select>
        </div>
      </div>
    </div>
