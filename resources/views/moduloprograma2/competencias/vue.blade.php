...
Vue.component('ckeditor2', {
 ...
 let app = new Vue({
    ...
    data:{
      titulo:"La Carrera",
        subtitulo: "Gestión de Competencias",
        ...
        fillobject:{ 'id':'', 'titulo':'', 'tipo':'', 'descripcion':'','nombrefile':'','url':'', 'urlfile':'','activo':'','oldImg':'', 'oldFile':'', 'tieneimagen':'','tienearchivo':''},
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var url = '/intranet/competenciasprogramare?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;
        ...
        create:function () {
            var url='/intranet/competenciasprogramare';
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/competenciasprogramare/'+dato.id;
        ...
        borrarImage:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/competenciasprogramare/deleteimg/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        borrarFile:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/competenciasprogramare/deletefile/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        cerrarFormE: function(){
            ...
            this.$nextTick(function () {
                this.fillobject={ 'id':'', 'titulo':'', 'tipo':'', 'descripcion':'','nombrefile':'','url':'', 'urlfile':'','activo':'','oldImg':'', 'oldFile':'', 'tieneimagen':'','tienearchivo':''};
        ...
        update: function (id) {
            ...
            var url="/intranet/competenciasprogramare/"+id;
        ...
        baja:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/competenciasprogramare/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
              title: '¿Estás seguro?',
              text: "Nota: Si activa el Contenido, se mostrará en el Portal del Programa de Estudio",
              type: 'info',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
              cancelButtonColor: '#d33',
            ...
            if (result.value) {
                var url = '/intranet/competenciasprogramare/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
