...
Vue.component('ckeditor2', {
 ...
 let app = new Vue({
    ...
    data:{
      titulo:"La Carrera",
        subtitulo: "Gestión del Campo Ocupacional",
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var url = '/intranet/camposocupacionalesprogramare?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3;
        ...
        create:function () {
            var url='/intranet/camposocupacionalesprogramare';
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/camposocupacionalesprogramare/'+dato.id;
        ...
        borrarImage:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/camposocupacionalesprogramare/deleteimg/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        borrarFile:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/camposocupacionalesprogramare/deletefile/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        update: function (id) {
            ...
            var url="/intranet/camposocupacionalesprogramare/"+id;
        ...
        baja:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/camposocupacionalesprogramare/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/camposocupacionalesprogramare/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
