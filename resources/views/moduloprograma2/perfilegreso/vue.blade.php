 ...
 let app = new Vue({
    ...
    methods: {
        ...
        getDatos: function (page) {
            ...
            var url = '/intranet/perfilprogramare?page='+page+'&busca='+busca+'&v1='+v1+'&v2='+v2+'&v3='+v3+'&tipo='+this.tipo;
        ...
        create:function () {
            var url='/intranet/perfilprogramare';
        ...
        borrar:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/perfilprogramare/'+dato.id;
        ...
        borrarImage:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/perfilprogramare/deleteimg/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        borrarFile:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/perfilprogramare/deletefile/'+dato.id;
                axios.delete(url).then(response=>{//eliminamos
        ...
        update: function (id) {
            ...
            var url="/intranet/perfilprogramare/"+id;
        ...
        baja:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/perfilprogramare/altabaja/'+dato.id+'/0';
      ...
      alta:function (dato) {
          swal.fire({
            ...
            if (result.value) {
                var url = '/intranet/perfilprogramare/altabaja/'+dato.id+'/1';
                axios.get(url).then(response=>{//eliminamos
